...
namespace HealthCare_.Models
{
    public class PrescriptionMed
    {
        ...
        public ICollection<DosingSchedule> DosingSchedules { get; set; } = new List<DosingSchedule>(); // Specific times for this medication
        ...
        public ICollection<Reminder> Reminders { get; set; } = new List<Reminder>(); // Auto-generated based on DosingSchedules
