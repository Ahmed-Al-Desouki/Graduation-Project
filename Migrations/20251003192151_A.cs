        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DoctorLicenseDoctorID = table.Column<int>(type: "int", nullable: true),
                    DoctorCertificateDoctorID = table.Column<int>(type: "int", nullable: true),
                    DoctorBioDoctorID = table.Column<int>(type: "int", nullable: true),
                    MedicalHistoryHistoryID = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attachments_Doctors_DoctorBioDoctorID",
                        column: x => x.DoctorBioDoctorID,
                        principalTable: "Doctors",
                        principalColumn: "DoctorID");
                    table.ForeignKey(
                        name: "FK_Attachments_Doctors_DoctorCertificateDoctorID",
                        column: x => x.DoctorCertificateDoctorID,
                        principalTable: "Doctors",
                        principalColumn: "DoctorID");
                    table.ForeignKey(
                        name: "FK_Attachments_Doctors_DoctorLicenseDoctorID",
                        column: x => x.DoctorLicenseDoctorID,
                        principalTable: "Doctors",
                        principalColumn: "DoctorID");
                    table.ForeignKey(
                        name: "FK_Attachments_MedicalHistories_MedicalHistoryHistoryID",
                        column: x => x.MedicalHistoryHistoryID,
                        principalTable: "MedicalHistories",
                        principalColumn: "HistoryID");
                    table.ForeignKey(
                        name: "FK_Attachments_MedicalHistories_MedicalHistoryID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attachments_DoctorBioDoctorID",
                table: "Attachments",
                column: "DoctorBioDoctorID");

            migrationBuilder.CreateIndex(
                name: "IX_Attachments_DoctorCertificateDoctorID",
                table: "Attachments",
                column: "DoctorCertificateDoctorID");

            migrationBuilder.CreateIndex(
                name: "IX_Attachments_DoctorLicenseDoctorID",
                table: "Attachments",
                column: "DoctorLicenseDoctorID");

            migrationBuilder.CreateIndex(
                name: "IX_Attachments_MedicalHistoryHistoryID",
                table: "Attachments",
                column: "MedicalHistoryHistoryID");

            migrationBuilder.CreateIndex(
                name: "IX_Attachments_MedicalHistoryID",
                table: "Attachments",
